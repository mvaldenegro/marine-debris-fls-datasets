#Adapted from https://github.com/oarriaga/paz/blob/master/paz/models/classification/xception.py

from keras.layers import Conv2D, BatchNormalization, SeparableConv2D
from keras.layers import Activation, MaxPooling2D, Add, Input
...
def MiniXception(input_shape, num_classes, width):
    stem_kernels = [width // 2, width]
    #block_data = [32, 64, 128, 256]
    block_data = [width, width * 2, width * 4, width * 8]
